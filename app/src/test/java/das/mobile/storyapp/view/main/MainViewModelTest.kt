...
import das.mobile.storyapp.DataDummy
import das.mobile.storyapp.MainDispatcherRule
...
import das.mobile.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val data: PagingData<Story> = QuotePagingSource.snapshot(dummyStoryResponse.listStory)
        val expectedStory = MutableLiveData<PagingData<Story>>()
        expectedStory.value = data
        Mockito.`when`(repository.getStories()).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(repository)
        val actualStory: PagingData<Story> = mainViewModel.getStories().getOrAwaitValue()
